<div id="divForm">
    ...
    <h3>Cadastre-se</h3>
    <form method="POST" action="../controller/cadastroAdmin.php" id="form">
        <div class="divInput">
            <label for="nameAdmin">Nome Completo</label>
            <input name="nameAdmin" id="nameAdmin" class="inputForm" type="text" placeholder="Digite seu nome...">
        </div>
        ...
        <div class="divInput">
            ...
            <div class="input-container">
                <input name="senhaAdmin" id="senhaAdmin" class="inputForm" type="password" placeholder="Crie uma senha...">
                <span class="fa fa-eye-slash" id="iconePassword"></span> 
            </div>
        </div>

        <input type="submit" value="Cadastrar" id="cadastrar" name="cadastrar">
        <p id="pArea">Já tem uma conta? <a id="aArea" href="../templates/loginAdmin.php">Faça login!</a></p>
    </form>
</div>
